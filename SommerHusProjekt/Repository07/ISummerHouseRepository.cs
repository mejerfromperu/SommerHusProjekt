...
namespace SommerHusProjekt.Repository07
{
    public interface ISummerHouseRepository
    {
        ...
        List<SummerHouse> Search(int? id, string? streetName, string? houseNumber, string? floor, int? postalCode, decimal? price, int? amountSleepingSpace, DateTime? dateFrom, DateTime? dateTo);
